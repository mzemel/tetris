module Pieces
  class L < Base
    ...
    def redraw_north(x: x, y: y)
      ...
      @blocks << Block.new(x: x, y: y + Block::HEIGHT, piece: self, center: false, asset: "9_12.png")
    ...
    def redraw_west(x: x, y: y)
      ...
      @blocks << Block.new(x: x, y: y, piece: self, center: true, asset: "horizontal.png")
      @blocks << Block.new(x: x + Block::WIDTH, y: y, piece: self, center: false, asset: "6_9.png")
