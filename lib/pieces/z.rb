module Pieces
  class Z < Base
    ...
    def redraw_north(x: x, y: y)
      ...
      @blocks << Block.new(x: x, y: y - Block::HEIGHT, piece: self, center: false, asset: "3_6.png")
      @blocks << Block.new(x: x + Block::WIDTH, y: y - Block::HEIGHT, piece: self, center: false, asset: "head_east.png")
    end
